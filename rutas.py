...
key = "aca252dc-211b-4bb2-a07e-c459e2721f7f"      # Replace with your Graphhopper API key
...
while True:
    ...
    vehicle = input("Ingrese uno de los perfiles de transporte mostrador en la lista anterior: ")
